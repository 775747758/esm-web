...
<body style="background-image:url(images/login_bg.png);">
	<div class="login_box">
        <form method="" action="" class="box">
	        ...
	        <label  class="lablePw" for="pass" >密&nbsp;&nbsp; 码&#58;</label>
	        <input class="pass01" type="password" name="password" /><br>
	        <div>
	        	<input id="jzmm" class="checkbox" type="checkbox" checked="true"  value="记住用户名"   name="checkbox" /><span style="font-size:18px;">记住用户名密码</span>
	     	</div>
