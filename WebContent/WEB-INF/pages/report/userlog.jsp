	...
	<table id="histories" class="easyui-datagrid" title="每日汇总表"
		...
		<thead>
			<tr>
				...
				<th data-options="field:'loginTime',width:200,align:'center',formatter:function(t){return new Date(t).format('yyyy-MM-dd hh:mm:ss');}">登录时间</th>
				<th data-options="field:'logoutTime',width:200,align:'center',formatter:function(t){return new Date(t).format('yyyy-MM-dd hh:mm:ss');}">退出时间</th>
