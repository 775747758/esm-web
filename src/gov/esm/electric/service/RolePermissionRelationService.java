...
public class RolePermissionRelationService {
	...
	private static final String sql_getPermissionsByRoleId = "select * from permission where leaderId < 0 union all select permission.* from role_permission_relation as relation , permission where relation.permissionId=permission.id and relation.roleId=?";
